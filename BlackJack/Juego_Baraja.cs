    ...
    public partial class Juego_Baraja : Form
    {
        ...
        private void B_Pedir_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    i = (i < 6) ? i : 6;
                    cartasJugador[i].Image = (i < 6) ? Image.FromFile("C:\\Users\\jacob\\Desktop\\NUEVO PROYECTO POO\\Imagenes\\" + carta.Descripcion + ".jpg") : cartasJugador[i].Image;
                    B_Pedir.Visible = (i == 6) ? false : B_Pedir.Visible;
                    i++;
                });
